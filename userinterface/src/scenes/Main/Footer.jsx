...
const Footer = () => {
  return (
    <div
      className="w-full bg-[#263238] flex p-8"
      style={{
        paddingLeft: "120px",
        paddingRight: "120px",
    ...
    >
      ...
      >
        ...
        {/* Copyright Section */}
        <div
          className="flex flex-col items-start gap-1 opacity-100"
          style={{ paddingLeft: "80px", paddingRight: "120px" }}
        >
          <div className="text-white text-[14px]">
            Copyright © 2024 ChatBOT Ltd.
          </div>
        ...
        {/* Social Links */}
        <div
          className="flex flex-row items-center gap-6 mt-4"
          style={{ paddingLeft: "80px", paddingRight: "120px" }}
        >
          <a
      ...
      >
        ...
        <div className="flex flex-col items-start gap-3">
          <h4 className="font-inter font-semibold text-[20px] text-white">
            Company
          </h4>
          <Link to="/about" className="w-40 h-5 text-[14px] text-[#F5F7FA]">
            About Us
          </Link>
          <Link to="/blog" className="w-40 h-5 text-[14px] text-[#F5F7FA]">
            Blog
          </Link>
          <Link to="/contact" className="w-40 h-5 text-[14px] text-[#F5F7FA]">
            Contact Us
          </Link>
        </div>
        ...
        {/* Column 2: Support */}
        <div className="flex flex-col items-start gap-3">
          <h4 className="font-inter font-semibold text-white text-[20px] leading-[28px]">
            Support
          </h4>
          <Link
            to="/help-center"
            className="text-[#F5F7FA] text-[14px] leading-[20px]"
          >
            Help Center
          </Link>
          <Link
