...
const Form = () => {
  ...
  return (
    <div className="relative h-screen bg-[#F06419] flex items-center justify-center">
      {/* Group 1000001764 */}
      <div
        className="absolute"
        style={{
      ...
      >
        ...
        <div
          ...
          }} // Adjusted height and top position
        >
          {/* Contact Information */}
          ...
          <div className="flex">
            {[
              ...
              <div className="flex items-center mr-4 relative" key={index}>
                ...
                <label
                  htmlFor={subject}
                  className={`font-poppins font-normal text-[12px] ml-2 ${selectedSubject === subject ? "font-bold" : "text-[#8D8D8D]"}`}
                >
                  {subject}
                </label>
              </div>
        ...
        {/* Message Input Area */}
        <div className="absolute" style={{ left: "668px", top: "350px" }}>
          {" "}
