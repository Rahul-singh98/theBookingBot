...
const EmailConditionalNodeMenu = ({ data, setQuestionData }) => {
            ...
            {conditionData.branches.map((branch, index) => (
                <div key={index} className="border rounded-md p-3 mb-3">
                    ...
                    <div className="mb-2">
                        ...
                        <input
                            type="text"
                            name="condition.send_to"
                            value={branch.condition.send_to}
                            onChange={(e) => handleBranchChange(index, e)}
                    ...
                    <div className="mb-2">
                        ...
                        <input
                            type="text"
                            name="condition.check_variable"
                            value={branch.condition.check_variable}
                            onChange={(e) => handleBranchChange(index, e)}
                            placeholder="Enter optional check variable"
...
export default EmailConditionalNodeMenu;